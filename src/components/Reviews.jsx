function Reviews({ darkMode }) {
  ...
  return (
    <section className="relative bg-cover bg-center py-10 px-8 text-white overflow-hidden">
      <div
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {reviews.map((r, i) => (
            ...
            >
              ...
              <span className="text-sm italic text-gray-400">{r.author}</span>
            </div>
          ))}
        </div>
      </div>
