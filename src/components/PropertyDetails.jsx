function PropertyDetails() {
    return (
      <section className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-14 mb-16">
        {/* Cím + ár + helyszín */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <div>
            <h1 className="text-4xl font-bold text-gray-900">Modern Mansion</h1>
            <p className="text-lg text-gray-600 mt-4">Madrid, Spain</p>
          </div>
          <div className="text-right md:mt-0">
            <p className="text-4xl font-bold text-emerald-600">525.000 €</p>
            <p className="text-lg text-gray-400 mt-4">VAT included</p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-2">
          ...
          <div className="flex-1">
            <table className="w-full text-lg leading-10 text-left text-gray-700">
              <tbody>
                <tr>
        ...
        <div className="mt-16 text-justify text-xl leading-10 text-gray-800">
            <p>
